...
$subject="$objet"; 
$destinataire="bonix.dan@gmail.com";
$body="$message"; 
...
?>
    ...
    <?php
	/* 
    $destinataire = 'bonixdan@gmail.com';
    ...
    {
    	//Fonction pour nettoyer et enregistrer un texte
    	function Rec($text)
    	{
    	...
    	//Fonction pour vérifier la syntaxe d'un email
    	...
    	//Formulaire envoyé, récupération de tous les champs
